...
const Projects = () => {
  return (
    <section className='projects'>
      ...
      <Project name={"ROCK, PAPER AND SCISSORS"} projectLink1={"https://github.com/FacuAlvarez00/RockPaperScissors---REACT"}  projectLink2={"https://rock-paper-scissors-react-dlr9rjuva-facualvarez00.vercel.app/"} img={project1} desc={"A web application for playing the game of rock-paper-scissors, which allows users to log in, select a personalized avatar, access their game statistics, view a leaderboard to track progress of all players, and features a user-friendly UI design that is adaptable to any device."} techIcon1={react} techIcon2={typescript} techIcon3={css} techIcon4={firebase}/>

       {/* <Project name={"Random People"} img={project2} desc={"This app consumes an API which generates random people, with filters to separate them by gender and name."} techIcon1={react} techIcon2={typescript} techIcon3={css} techIcon4={tailwind}/> */}
